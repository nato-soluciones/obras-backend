...
class CurrentAccountMovementTypesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $movementsTypes = [
            ...
            ["name" => 'Notas de débito', "type" => 'DEBIT', 'active' => true, 'entity_type' => 'PROVIDER', 'system_type' => false],
            ["name" => 'Notas de crédito ', "type" => 'CREDIT', 'active' => true, 'entity_type' => 'PROVIDER', 'system_type' => false],
            ...
            ["name" => 'Otros débitos', "type" => 'DEBIT', 'active' => true, 'entity_type' => 'PROVIDER', 'system_type' => false],
            ["name" => 'Otros créditos', "type" => 'CREDIT', 'active' => true, 'entity_type' => 'PROVIDER', 'system_type' => false],
            ...
            ["name" => 'Ingreso', "type" => 'CREDIT', 'active' => true, 'entity_type' => 'PROVIDER', 'system_type' => true],
            ["name" => 'Egreso', "type" => 'DEBIT', 'active' => true, 'entity_type' => 'PROVIDER', 'system_type' => true],
            ["name" => 'Ingreso - Eliminado', "type" => 'DEBIT', 'active' => true, 'entity_type' => 'PROVIDER', 'system_type' => true],
            ["name" => 'Egreso - Eliminado', "type" => 'CREDIT', 'active' => true, 'entity_type' => 'PROVIDER', 'system_type' => true],
